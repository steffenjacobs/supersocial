            ...
            <div className="landing-site-inner">
                ...
                <div className="landing-box">
                    ...
                    <div className="landing-content-container">
                        <div className="landing-img-container landing-img-container-small"><img alt="Activate your data" src="frontpage/integrate-data.svg" /></div>
                ...
                <div className="landing-box">
                    ...
                    <div className="landing-content-container">
                        ...
                        <div className="landing-img-container landing-img-container-small"><img alt="Make the right choices" src="frontpage/decision.svg" /></div>
                    </div>
                </div>
                ...
                <div className="landing-box">
                    ...
                    <div className="landing-content-container">
                        <div className="landing-img-container landing-img-container-small"><img alt="Gain new insides" src="frontpage/lightbulb.svg" /></div>
                ...
                <div className="landing-box">
                    ...
                    <div className="landing-content-container">
                        ...
                        <div className="landing-img-container landing-img-container-small"><img alt="Give away control" src="frontpage/joystick.svg" /></div>
                    </div>
                </div>
                ...
                <div className="landing-box">
                    ...
                    <div className="landing-content-container">
                        ...
                        <div className="landing-img-container landing-img-container-small"><img alt="Realtime data streams" src="frontpage/datastreams.svg" /></div>
                    </div>
                </div>
                ...
                <div className="landing-box">
                    ...
                    <div className="landing-content-container">
                        <div className="landing-img-container landing-img-container-small"><img alt="Intelligible Visualization" src="frontpage/graph.svg" /></div>
