export enum EventBusEventType { SELECTED_POST_CHANGED, REFRESH_POSTS, USER_CHANGE, REFRESH_SOCIAL_MEDIA_ACCOUNTS, SELECTED_SOCIAL_MEDIA_ACCOUNT_CHANGED, REFRESH_POST_ANALYTICS, REFRESH_ACCOUNT_ANALYTICS, REFRESH_POST_ANALYTICS_REQ, REFRESH_ACCOUNT_ANALYTICS_REQ };
