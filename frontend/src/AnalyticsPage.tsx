            ...
            <div>
                <div className="filter-area">
                    <Multiselect
                        ...
                        groupBy="type"
                    />
                    {SnippetManager.createInfoWithoutTooltip(SnippetManager.createConfluenceLink("Filters+on+the+Analytics+Dashboard"), "Hint: If you select all filters, the result is the same as if no filter was selected at all. The filter are combined with a logical or. More information are available ", "hint")}
                </div>
